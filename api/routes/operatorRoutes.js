...
router.get("/get-all-appointments/:numberOfPages", validateMiddleware, operatorController.get_all_appointments_get);
...
router.put("/edit-appointment/:appointmentId",validateMiddleware, operatorController.edit_status_of_appointment
);
